...
/**
 * Stateless JWT security. There is no session, no form login and no CSRF token:
 * every protected call must carry {@code Authorization: Bearer <token>}.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Vite dev server and CRA dev server.
